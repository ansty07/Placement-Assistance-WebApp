...
<img width="1898" height="867" alt="Screenshot 2026-07-10 222323 - Edited" src="https://github.com/user-attachments/assets/be98301d-f019-47c4-9aef-5b72f98ae3e6" />
...
Want a question set tailored to a specific company, question type, question count, and time limit? Copy the prompt from [`PROMPT.md`](./PROMPT.md) and paste it into your preferred AI chat tool — it will generate a ready-to-use JSON file matching AptiQ's format, customized to your desired company, question type, number of questions, and duration.
